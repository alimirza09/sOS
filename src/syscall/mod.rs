...
//! | 12     | `gpu_info`   | `sys_gpu_info`    | Returns `width | (height << 32)`                                  |
//! | 13     | `gpu_map`    | `sys_gpu_map`     | `a0=user_addr` - Maps framebuffer, returns mapped addr           |
//! | 14     | `gpu_flush`  | `sys_gpu_flush`   | Flushes framebuffer to display                                     |
//!
//! ## Notes
...
pub const SYS_GPU_INFO: u64 = 12;
pub const SYS_GPU_MAP: u64 = 13;
pub const SYS_GPU_FLUSH: u64 = 14;
